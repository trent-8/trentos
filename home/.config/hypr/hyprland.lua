...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("brightnessctl --min-value=1000 set 5%+"),                  { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("brightnessctl --min-value=1000 set 5%-"),                  { locked = true, repeating = true })
