...
/* tagging */
static const char *tags[] = { "tty", "󰖟", "󰉋", "󰨞", "" };
...
/* commands */
static const char *launchercmd[] = { "rofi", "-show", "drun", "-theme", "android_notification", "-font", "\"Roboto 11\"", "-icon-theme", "Papirus", "-show-icons", NULL };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_p,                      spawn,          SHCMD ("spotify-launcher")},
